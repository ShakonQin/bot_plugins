...
class PluginLoader:
    ...
    def __init__(self) -> None:
        ...
        # 热重载相关（Queue 延迟到 setup_hot_reload 中创建，避免绑定错误的 event loop）
        self._reload_queue: Optional[asyncio.Queue[str]] = None
    ...
    def setup_hot_reload(
        ...
        self._reload_task = asyncio.ensure_future(self._reload_consumer())
        LOG.info("热重载已启动")
